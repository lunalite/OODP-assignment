...
public class CZ2002_Assignment {
    ...
    /**
     * Temp later day for check out convenience
     */
    // new GregorianCalendar().get(Calendar.DAY_OF_MONTH) + 3;
    public static final int laterDay = 4; //later Day of system (Currently for April alone)
    
    /**
     * Days currently within the month of April 
     */
     ...
     *
     * @param args Program entry parameters
     */
    public static void main(String[] args) {
        ...
        do {
            ...
            // Test Cases
            /** 
             * - 2 guests occupied each room type (single, standard, VIP, suite,
             * deluxe,) with different details, eg bed type, etc. - 2 rooms of
             * each room availability status Under Maintenance. - 3 reservations
             * with corresponding different guest details [* set check-in date
             * as 1 week later] - At least 5 room service menu items
             */
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    //Pay total Bill
                        ...
                        Room r = RoomMgr.getRoom(roomNumber_4);
                        if (r.getStatusCalendar(laterDay).getStatus() == RoomStatus.OCCUPIED)
                            break;
     ...
     *
     * @param roomN The room number to find
     * @param rooms The room array to iterate through
     * @return the result if room number is present in the rooms array
     */
    public static boolean roomNoCheck(String roomN, Room[] rooms) {
        ...
        /**
     * Check if end date is earlier than the start date is present
     *
     * @param start The start date integer within April 2016
     * @param end The end date integer within April 2016
     * @return the boolean false if end less than start, and true if otherwise.
     */
